...
template <class ItemType>
ItemType UnsortedType<ItemType>::SumSquares_a(NodeType<ItemType>*
	list)
{
	//a번 문제의 내용 수정
	//a번 문제의 에러 발생 이유 주석으로 작성
	//리턴값이 바로 나와 뒤의 내용이 실행되지 않는다.
	if (list != NULL)
...
template <class ItemType>
ItemType UnsortedType<ItemType>::SumSquares_b(NodeType<ItemType>*
	list)
{
	//info의 제곱값을 더해야한다.
	int sum = 0;
...
template <class ItemType>
ItemType UnsortedType<ItemType>::SumSquares_c(NodeType<ItemType>*
	list)
{
	//정상 작동
	if (list == NULL)
...
template <class ItemType>
ItemType UnsortedType<ItemType>::SumSquares_d(NodeType<ItemType>*
	list)
{
	//정상 작동
	if (list->next == NULL)
...
template <class ItemType>
ItemType UnsortedType<ItemType>::SumSquares_e(NodeType<ItemType>*
	list)
{
	//제곱값을 더하는 실행이 없다.
	if (list == NULL)
